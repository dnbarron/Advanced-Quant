...
The Kaufman Assessment Battery for Children is an individually administered cognitive ability test for children.  The eight items are claimed to be measures of two factors: sequential processing and simultaneous processing.  The former require correct recall of auditory stimuli (nr: Number Recall, wo: Word Order) or visual stimuli (hm: Hand Movements) in a particular order.  The latter are intended to measure more holistic, less order-dependent reasoning (gc: Gestalt Closure, tr: Triangles, sm: Spatial Memory, ma: Matrix Analogies, ps: Photo Series).  We will perform a CFA using these tests on 200 children aged 10.  The covariance matrix is:

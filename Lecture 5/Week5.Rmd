...
```{r mod2}
m2 <- lmer(Happy ~ Age + I(Age^2/1000) + Marital2 + Sex + Gini + I(GDP/1000) + EDUyears + (1|cntry), 
           data = ess)
display(m2)
```
...
m3 <- lmer(Happy ~ Age + I(Age^2/1000) + Marital2 + Sex + Gini + GDPk + EDUyears + (1 + EDUyears|cntry), 
           data = ess)
display(m3)
anova(m2, m3)
